        ...
        <div className="p-6 lg:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card className="p-6 bg-card border-border">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Shared Reports</p>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-4 p-3 bg-muted/30 rounded-lg">
                        <div>
                          ...
                          <div className="text-sm font-semibold text-foreground">{report.metrics.avgPm25}</div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground mb-1">Change</div>
                          <div className="text-sm font-semibold text-success">↓ {report.metrics.reduction}</div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground mb-1">Trips</div>
                          <div className="text-sm font-semibold text-foreground">{report.metrics.trips}</div>
                        </div>
                      </div>
          ...
          <Card className="p-6 bg-card border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border border-border rounded-lg hover:border-primary transition-colors cursor-pointer">
                ...
                <h4 className="font-semibold text-foreground mb-2">Emission Summary</h4>
          ...
          <Card className="p-6 bg-primary/5 border-primary/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">Export Formats Available</h4>
                <p className="text-sm text-muted-foreground mb-3">
                  Download your reports in multiple formats for easy sharing and compliance submissions
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge className="bg-card text-foreground border-border">PDF</Badge>
                  <Badge className="bg-card text-foreground border-border">CSV</Badge>
                  <Badge className="bg-card text-foreground border-border">Excel</Badge>
                  <Badge className="bg-card text-foreground border-border">JSON</Badge>
                </div>
              </div>
            </div>
          </Card>
